...
class AppSettingsController extends GetxController {
  ...
  void onInit() {
    ...
    showCurrentTime.value = LocalStorageService.instance
        .getValue(LocalStorageService.kShowCurrentTime, false);
  ...
  var showCurrentTime = false.obs;
  void setShowCurrentTime(bool e) {
    showCurrentTime.value = e;
    LocalStorageService.instance
        .setValue(LocalStorageService.kShowCurrentTime, e);
  }
