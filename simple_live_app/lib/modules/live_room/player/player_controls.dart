...
class _CurrentTimeWidget extends StatefulWidget {
  const _CurrentTimeWidget();

  @override
  State<_CurrentTimeWidget> createState() => _CurrentTimeWidgetState();
}

class _CurrentTimeWidgetState extends State<_CurrentTimeWidget> {
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Obx(
                    () => Visibility(
                      visible: AppSettingsController.instance.showCurrentTime.value,
